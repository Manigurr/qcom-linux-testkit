...
# ==============================================================================
#  Compliance H.264 Filtering (1 Decode + 1 Encode)
# ==============================================================================
if [ "$COMPLIANCE_H264" -eq 1 ]; then
    ...
    # Overwrite the main list with our filtered list
